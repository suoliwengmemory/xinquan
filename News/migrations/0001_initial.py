    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='xinwen/%Y/%m', verbose_name='封面')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=30, verbose_name='标题')),
                ('image', models.ImageField(upload_to='chanpin/%Y/%m', verbose_name='封面')),
                ('detail', DjangoUeditor.models.UEditorField(default='', verbose_name='产品内容')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '药柜产品',
                'verbose_name_plural': '药柜产品',
            },
        ),
        migrations.CreateModel(
            name='Store',
